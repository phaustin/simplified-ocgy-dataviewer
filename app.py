...
def update_hover_station(hov_data, cruise, hov_station_json):
    ...
    return json.dumps(
        hov_station.__dict__
    )  # return a json dict of the station to be stored
...
def update_click_stations(click_data, click_stations_json, cruise):
    ...
    return json.dumps(
        click_stations, default=station_dict
    )  # convert to json and return clicked_stations
